...
class CommonPlatformCourtEventListenerIntTest : MessagingMultiNodeTestBase() {
  ...
  fun `should create new people with additional fields from common platform message`() {
    ...
    assertThat(firstPerson.nationalities.first().nationalityCode?.code).isEqualTo(firstNationality.getNationalityCodeFromCommonPlatformCode()?.code)
    assertThat(firstPerson.nationalities.first().nationalityCode?.description).isEqualTo(firstNationality.getNationalityCodeFromCommonPlatformCode()?.description)
    ...
    assertThat(firstPerson.getAliases()[0].lastName).isEqualTo("alisLastName1")
    ...
    assertThat(firstPerson.getAliases()[1].lastName).isEqualTo("alisLastName2")
    ...
    assertThat(secondPerson.nationalities.first().nationalityCode?.code).isEqualTo(secondNationality.getNationalityCodeFromCommonPlatformCode()?.code)
    assertThat(secondPerson.nationalities.first().nationalityCode?.description).isEqualTo(secondNationality.getNationalityCodeFromCommonPlatformCode()?.description)
