...
data class ProbationCaseResponseSetup(val crn: String, val cro: String, val pnc: String? = null, val prefix: String, val prisonNumber: String, val addresses: List<ProbationCaseResponseSetupAddress>, val nationalInsuranceNumber: String)
