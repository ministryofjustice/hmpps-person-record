...
class EthnicityCodeIntTest : IntegrationTestBase() {
  ...
  companion object {
    ...
    fun prisonEthnicityCodes(): Stream<Arguments> = Stream.of(
      ...
      Arguments.of("Black/Black British: Carribean", "B1", "Black/Black British : Carribean"),
      ...
      Arguments.of("Mixed: White and Black Carribean", "M1", "Mixed : White and Black Carribean"),
