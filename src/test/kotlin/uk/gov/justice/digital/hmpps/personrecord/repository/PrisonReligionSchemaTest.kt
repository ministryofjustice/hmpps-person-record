...
class PrisonReligionSchemaTest : IntegrationTestBase() {
  ...
  fun `should fail to insert multiple current religions`() {
    ...
    val religion = PrisonReligionEntity.from(prisonNumber, createRandomCurrentReligion(randomReligionCode()))
    val religion2 = PrisonReligionEntity.from(prisonNumber, createRandomCurrentReligion(randomReligionCode()))
