...
fun prisonerSearchResponse(responseSetup: ApiResponseSetup) = """
  {
    ...
    "nationalInsuranceNumber": "${responseSetup.nationalInsuranceNumber}",
    "driverLicenseNumber": "${responseSetup.driverLicenseNumber}",
    ...
    "birthplace": "${responseSetup.birthplace}",
    "birthCountry": "${responseSetup.birthCountry}",
    "sexualOrientation": "${responseSetup.sexualOrientation}",
    "sex": "${responseSetup.sex}",
    "gender": "Female",
    "ethnicity": "White: Eng./Welsh/Scot./N.Irish/British",
    "youthOffender": true,
    "maritalStatus": "Widowed",
    "religion": "${responseSetup.religion}",
    "nationality": "${responseSetup.nationality}",
    "status": "ACTIVE IN",
