...
class PopulatePersonMatchIntTest : WebTestBase() {
  ...
  @Nested
  inner class PopulatePersonMatchMigrate {
  ...
  @Nested
  inner class PopulatePersonMatchSinglePerson {

    @Test
    fun `should populate single person from match id`() {
      ...
      webTestClient.post()
        .uri("/populatepersonmatch/person?matchId=${person.matchId}")
        .exchange()
        .expectStatus()
        .isOk
