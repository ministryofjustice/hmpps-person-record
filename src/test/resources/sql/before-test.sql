...
VALUES
    ...
    (-3, -2,'PNC123456', 'CRN1234', 'John', null, null, 'Mahoney', 'Male', '1965-06-18', 'test', CURRENT_TIMESTAMP, 'test', CURRENT_TIMESTAMP, 0),
    (-4, -2,'PNC123456', 'CRN1234', 'John', null, null, 'Mahoney', 'Male', '1965-06-18', 'test', CURRENT_TIMESTAMP, 'test', CURRENT_TIMESTAMP, 0),
    ...
    (-8, -3,'pnc33333', 'CRN1234', 'Bob', null, null, 'Mortimer', 'Male', '1965-06-18', 'test', CURRENT_TIMESTAMP, 'test', CURRENT_TIMESTAMP, 0);

INSERT INTO offender
(id, fk_person_id, crn, pnc_number, created_by, created_date, last_updated_by, last_updated_date, "version")
VALUES
    (-1, -1,'CRN1234', 'PNC12345', 'test', CURRENT_TIMESTAMP, 'test', CURRENT_TIMESTAMP, 0),
