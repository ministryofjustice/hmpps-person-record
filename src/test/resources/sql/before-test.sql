...
VALUES
    ...
    (-4, -2,'PNC12345', 'CRN1234', 'John', null, null, 'Mahoney', 'Male', '1965-06-18', 'test', CURRENT_TIMESTAMP, 'test', CURRENT_TIMESTAMP, 0),
...
VALUES
    ...
    (-2, -3,'CRN5432', 'test', CURRENT_TIMESTAMP, 'test', CURRENT_TIMESTAMP, 0),
    (-3, -4,'CRN4444', 'test', CURRENT_TIMESTAMP, 'test', CURRENT_TIMESTAMP, 0);
