  ...
  fun processPersonFromCourtCaseEvent(person: Person) {
    ...
    person.otherIdentifiers?.pncIdentifier?.let { pncIdentifier ->
      ...
      if (pncIdentifier.isValid()) {
        ...
        val defendants = personRepository.findByDefendantsPncNumber(PNCIdentifier.create(pncId))?.defendants.orEmpty()
        ...
        telemetryService.trackEvent(TelemetryEventType.INVALID_PNC, mapOf("PNC" to pncIdentifier.toString()))
      }
    }
  }
