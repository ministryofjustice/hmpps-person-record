...
class PrisonReligionUpdateHandler(private val prisonReligionRepository: PrisonReligionRepository) {
  ...
  fun validateRequest(cprReligionId: String, updateRequest: PrisonReligionUpdateRequestBody): PrisonReligionEntity {
  ...
  private fun isAttemptingToPromoteHistoricPrisonReligion(
    ...
    updateRequest: PrisonReligionUpdateRequestBody,
  ) = updateRequest.current && existingPrisonReligion.prisonRecordType == PrisonRecordType.HISTORIC

  fun updatePrisonReligion(updateRequest: PrisonReligionUpdateRequestBody, existingPrisonReligion: PrisonReligionEntity): PrisonReligionEntity {
