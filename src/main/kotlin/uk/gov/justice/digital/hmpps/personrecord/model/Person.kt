...
data class Person(
  ...
  companion object {
    ...
    fun from(offenderDetail: OffenderDetail): Person {
      return Person(
        ...
        otherIdentifiers = OtherIdentifiers(
          ...
          pncIdentifier = PNCIdentifier.create(offenderDetail.otherIds.pncNumber),
    ...
    fun from(defendant: Defendant): Person {
      return Person(
        otherIdentifiers = OtherIdentifiers(pncIdentifier = PNCIdentifier.create(defendant.pncId), cro = defendant.croNumber),
    ...
    fun from(libraHearingEvent: LibraHearingEvent): Person {
      return Person(
        otherIdentifiers = OtherIdentifiers(pncIdentifier = PNCIdentifier.create(libraHearingEvent.pnc), cro = libraHearingEvent.cro),
    ...
    fun from(prisoner: Prisoner): Person {
      return Person(
        otherIdentifiers = OtherIdentifiers(
          pncIdentifier = PNCIdentifier.create(prisoner.pncNumber),
