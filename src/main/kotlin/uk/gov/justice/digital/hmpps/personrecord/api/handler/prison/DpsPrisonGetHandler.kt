...
class DpsPrisonGetHandler(
  ...
  fun get(prisonNumber: String): ResponseEntity<DpsPrisonRecord> {
  ...
  private fun respondWithRedirect(targetPrisonNumber: String): ResponseEntity<DpsPrisonRecord> = ResponseEntity
