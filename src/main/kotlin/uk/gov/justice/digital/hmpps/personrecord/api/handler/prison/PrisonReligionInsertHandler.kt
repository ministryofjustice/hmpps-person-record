...
interface PrisonReligionInsertHandler {
  fun handleInsert(prisonNumber: String, prisonReligionHistory: PrisonReligionHistory): PrisonReligionMapping
}

@Component
@Profile("preprod | prod")
class PrisonReligionInsertHandlerProd(
  private val prisonReligionRepository: PrisonReligionRepository,
  private val personRepository: PersonRepository,
  private val personService: PersonService,
  private val publisher: ApplicationEventPublisher,
) : PrisonReligionInsertHandler {

  @Transactional
  override fun handleInsert(prisonNumber: String, prisonReligionHistory: PrisonReligionHistory): PrisonReligionMapping {
...
@Component
@Profile("!preprod & !prod")
class PrisonReligionInsertHandlerDev(
  private val prisonReligionRepository: PrisonReligionRepository,
  private val personRepository: PersonRepository,
  private val personService: PersonService,
  private val publisher: ApplicationEventPublisher,
