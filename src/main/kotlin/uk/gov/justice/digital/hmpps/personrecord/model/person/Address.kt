...
data class Address(
  ...
  companion object {
    fun from(address: PrisonerAddress): Address? = Address(
      ...
      startDate = address.startDate?.toOffsetDateTime(),
    ...
    fun from(address: SysconAddress): Address = Address(
      noFixedAbode = address.noFixedAbode,
      startDate = address.startDate?.let { address.startDate.toOffsetDateTime() },
      endDate = address.endDate?.let { address.endDate.toOffsetDateTime() },
